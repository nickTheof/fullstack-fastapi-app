...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'theofann'
    assert response.json()['email'] == 'theofanntest@email.com'
    assert response.json()['first_name'] == 'Nikolas'
    assert response.json()['last_name'] == 'Theofanis'
